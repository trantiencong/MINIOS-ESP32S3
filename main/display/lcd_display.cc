...
void LcdDisplay::SetupUI() {
    ...
    lv_obj_set_size(emoji_box_, profile.emoji_box_size, profile.emoji_box_size);
    ...
    lv_obj_set_scrollbar_mode(status_bar_, LV_SCROLLBAR_MODE_OFF);
    lv_obj_set_style_layout(status_bar_, LV_LAYOUT_NONE, 0);  // Use absolute positioning
    lv_obj_align(status_bar_, LV_ALIGN_CENTER, 0, profile.status_bar_offset_y);  // Overlap with top_bar_
